...
image::./images/MSVC++2.png["Wählen Sie 'Fortfahren'."]

image::./images/MSVC++3.png["Wählen Sie 'Developmententwicklung mit C++' und dann 'Installieren'."]

Nun können Sie die COCO API installieren.
